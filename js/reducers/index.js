...
import { NavigatorTabReddit } from "../containers/reddit/navigationConfiguration";
...
import {
  ...
  ShowListReducer,
  JobListReducer,
  RedditTechnologyListReducer,
  RedditProgrammingListReducer
...
const rootReducer = combineReducers({
  ...
  tabReddit: (state, action) =>
    NavigatorTabReddit.router.getStateForAction(action, state),
  // tabAsk: (state, action) =>
  ...
  jobs: JobListReducer,
  technology: RedditTechnologyListReducer,
  programming: RedditProgrammingListReducer,
